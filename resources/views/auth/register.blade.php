...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="g-recaptcha" id="recap" data-sitekey="6LeLGw0jAAAAADuJBosBQG6WPtVWQ9HZ6C92JjlR">
                            </div>
    ...
    {{-- 6LeLGw0jAAAAADuJBosBQG6WPtVWQ9HZ6C92JjlR      KEY
        6LeLGw0jAAAAAEzt2E5ejQj4oU48Ri1PyHj142f-      SECRET --}}
@endsection
@section('scriptTop')
